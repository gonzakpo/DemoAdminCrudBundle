...
class Post
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Page", inversedBy="postsEmbeds")
     * @ORM\JoinColumn(name="page_embed_id", referencedColumnName="id")
     */
    private $pageEmbed;
     ...
     * Set pageEmbed
     *
     * @param \AppBundle\Entity\Page $pageEmbed
     *
     * @return Post
     */
    public function setPageEmbed(\AppBundle\Entity\Page $pageEmbed = null)
    {
        $this->pageEmbed = $pageEmbed;
